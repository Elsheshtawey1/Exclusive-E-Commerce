...
return response.json()}).then((data)=>{console.log(data);const items=document.getElementById('allproudct');all_products_json=data;data.forEach((product)=>{items.innerHTML+=`
